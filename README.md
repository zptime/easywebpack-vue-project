...
# （2）文档：https://www.yuque.com/easy-team/egg-vue/init
...
# 项目地址：
$ 前端地址：http://127.0.0.1:7001/ 或者 http://localhost:7001/
$ 管理端地址：http://127.0.0.1:7001/admin 或者 http://localhost:7001/admin
